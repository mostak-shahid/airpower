...
function airpower_enqueue_scripts() {
	global $airpower_options;
	wp_enqueue_script( 'jquery' );	
	wp_register_style( 'google-font', 'https://fonts.googleapis.com/css2?family=Tajawal:wght@200;300;400;500;700;800;900&display=swap' );
	...
	if ($airpower_options['basic-styling-stylesheet']) {
		wp_register_style( $airpower_options['basic-styling-stylesheet'], get_template_directory_uri() .  '/css/'.$airpower_options['basic-styling-stylesheet'].'.css', array('main.min'));
		wp_enqueue_style( $airpower_options['basic-styling-stylesheet'] );		
	}

}
add_action( 'wp_enqueue_scripts', 'airpower_enqueue_scripts' );
function airpower_admin_enqueue_scripts(){
	wp_register_style( 'font-awesome.min', get_template_directory_uri() . '/fonts/font-awesome-4.7.0/css/font-awesome.min.css' );
...
add_action( 'admin_enqueue_scripts', 'airpower_admin_enqueue_scripts' );
