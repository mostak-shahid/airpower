<?php
    ...
    $terms = mos_get_terms ("service_type");
    if (sizeof($terms)){
        foreach($terms as $term) {
           $service_type[$term['term_id']] = $term['name']; 
        }
    }
    $args = array(
      'numberposts' => -1,
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'mode'     => 'css',
                'theme'    => 'monokai',
                //'desc'     => 'Possible modes can be found at <a href="' . 'http://' . 'ace.c9.io" target="_airpower">' . 'http://' . 'ace.c9.io/</a>.',
                //'default'  => "body{\n   margin: 0 auto;\n}"
            ),
            array(
                'id'       => 'misc-settings-js',
    ...
    //We Cover
    Redux::setSection( $opt_name, array(
        'title'            => __( 'We Cover', 'redux-framework-demo' ),
        'id'               => 'sections-wecover',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            array(
                'id'             => 'sections-wecover-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-wecover .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),
            ),  
            array(
                'id'             => 'sections-wecover-margin',
                'type'           => 'spacing',
                'mode'           => 'margin',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
            ...
            array(
                'id'       => 'sections-wecover-select',
                'type'     => 'select',
                'multi'    => true,
                'title'    => __( 'Select Types', 'redux-framework-demo' ),
                //'options'  => $service_type
                'data'     => 'pages',                
                'sortable' => true,
            ),
            array(
                'id'       => 'sections-wecover-color-type',
                'type'     => 'button_set',
                'title'    => __( 'Section text color', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                ...
                'required' => array( 'sections-wecover-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-wecover-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-wecover-color-type', '=', '2' ),
                'output'         => array( '#section-wecover' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-wecover-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-wecover a' ),
            ),
            array(
                'id'       => 'sections-wecover-background-type',
                'type'     => 'button_set',
                'title'    => __( 'Section Background Type', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                'id'       => 'sections-wecover-background',
                'type'     => 'select',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                //Must provide key => value pairs for select options
                'options'  => array(
                ...
                'required' => array( 'sections-wecover-background-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-wecover-background-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-wecover-background-type', '=', '2' ),
                'output'         => array( '#section-wecover' ),
                'mode'     => 'background-color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-wecover-bg',
                'type'     => 'background',
                'output'   => array( '#section-wecover' ),
                'title'    => __( 'Default Background', 'redux-framework-demo' ),
                'background-color' => false
    ...
    //Showcase
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Showcase', 'redux-framework-demo' ),
        ...
        'fields'     => array(
            array(
                'id'             => 'sections-showcase-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-showcase .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),
            ),  
            array(
                'id'             => 'sections-showcase-margin',
                'type'           => 'spacing',
                'mode'           => 'margin',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
            ...
            array(
                'id'       => 'sections-showcase-select',
                'type'     => 'select',
                'multi'    => true,
                'title'    => __( 'Select Projects', 'redux-framework-demo' ),
                'options'  => $projects
            ),
            array(
                'id'       => 'sections-showcase-color-type',
                'type'     => 'button_set',
                'title'    => __( 'Section text color', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                ...
                'required' => array( 'sections-showcase-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-showcase-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-showcase-color-type', '=', '2' ),
                'output'         => array( '#section-showcase' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-showcase-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-showcase a' ),
            ),
            array(
                'id'       => 'sections-showcase-background-type',
                'type'     => 'button_set',
                'title'    => __( 'Section Background Type', 'redux-framework-demo' ),
                'options'  => array(
                    '1' => 'Default Colors',
            ...
            array(
                'id'       => 'sections-showcase-background',
                'type'     => 'select',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                //Must provide key => value pairs for select options
                'options'  => array(
                ...
                'required' => array( 'sections-showcase-background-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-showcase-background-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-showcase-background-type', '=', '2' ),
                'output'         => array( '#section-showcase' ),
                'mode'     => 'background-color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-showcase-bg',
                'type'     => 'background',
                'output'   => array( '#section-showcase' ),
                'title'    => __( 'Default Background', 'redux-framework-demo' ),
                'background-color' => false
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                // Leave this as a airpower section, no options just some intro text set above.
                'fields' => array()
            );
