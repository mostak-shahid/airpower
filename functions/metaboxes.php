<?php
function airpower_metaboxes() {
    $prefix = '_airpower_';
    global $airpower_options,$template_parts;
    $blog_id = get_option( 'page_for_posts' );
    if (@$_GET['post'] == $blog_id){
        $enabled = ($airpower_options['archive-page-sections']['Enabled']) ? $airpower_options['archive-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($airpower_options['archive-page-sections']['Disabled']) ? $airpower_options['archive-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
    else{
        $enabled = ($airpower_options['general-page-sections']['Enabled']) ? $airpower_options['general-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($airpower_options['general-page-sections']['Disabled']) ? $airpower_options['general-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
...
add_action('cmb2_admin_init', 'airpower_metaboxes');