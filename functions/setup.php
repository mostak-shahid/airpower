<?php
//Add theme setup
if ( ! function_exists( 'airpower_setup' ) ) :
	function airpower_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'airpower'),
			'mobilemenu' => __('Mobile Menu', 'airpower'),
		));
...
add_action( 'after_setup_theme', 'airpower_setup' );